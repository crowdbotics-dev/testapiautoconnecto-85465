...
## Project Structure
    ...
    ├── testapiautoconnecto_85465  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_85465`
...
2. Clone this repo and `cd testapiautoconnecto_85465`
